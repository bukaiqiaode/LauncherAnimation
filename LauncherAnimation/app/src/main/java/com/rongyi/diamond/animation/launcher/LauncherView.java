...
public class LauncherView extends RelativeLayout {
    ...
    private void addAnimation(ObjectAnimator animator1, final ImageView target) {
        ...
        //build animator to do alpha/scaling(in the listener)
        ...
        //set to remove the item after animation
        valueAnimator.addListener(new AnimEndListener(target));

        //set the path-animator and the value-animator to play together
        //can we use less code here?
        if (target == red) {
